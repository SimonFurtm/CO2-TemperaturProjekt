...
class ChartGoveeTemp extends Component {
    constructor() {
      super();
      this.state = {
          chartData: []
  ...
  render(){
    ...
    var tmp = goveeData.map((goveeData) => ({
      datum: formate.changeDatumFormat(goveeData.Datum), co2: goveeData.Temperatur, time: formate.changeTimeFormat(goveeData.Uhrzeit)
    }));
